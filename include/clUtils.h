...
const char *const CL_ERROR_DEVICE_MAXCU = "Error: Could not get the maximum number of compute units";
const char *const CL_ERROR_DEVICE_MAXWORKITEMS = "Error: Could not get the maximum number of work-items in each dimension";
