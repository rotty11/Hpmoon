...
const char *const CFG_ERROR_THREADS_MIN = "Error: The number of CPU threads must be 0 or higher if the number of devices is 0";
...
typedef struct Config {
	...
	/**
	 * @brief The parameter indicating the number of subpopulations (islands) in this MPI process
	 */
	int nIslands;


	/**
	 * @brief The parameter indicating the number of individuals in the archipelago
	 */
	int archipelagoSize;


	/**
	 * @brief The parameter indicating the number of individuals in the archipelago (including parents and children)
	 */
	int archipelagoFamilySize;
