...
$(OBJ)/clUtils.o: $(SRC)/clUtils.cpp $(INC)/clUtils.h
...
$(OBJ)/ag.o: $(SRC)/ag.cpp $(INC)/ag.h
	$(COMP) $(CPPFLAGS) $(NFEATURES) $(OPT) $(OMP) -I$(OPENCL) $(SRC)/ag.cpp -o $(OBJ)/ag.o
$(OBJ)/evaluation.o: $(SRC)/evaluation.cpp $(INC)/evaluation.h
...
$(OBJ)/main.o: $(SRC)/main.cpp
	$(COMP) $(CPPFLAGS) $(NFEATURES) $(OPT) -I$(OPENCL) $(SRC)/main.cpp -I$(NVML) -o $(OBJ)/main.o

# ************ Linking and creating executable ************

$(BIN)/hpmoon: $(OBJECTS)
	@mkdir -p $(BIN) $(GNUPLOT)
	$(COMP) $(OBJECTS) -o $(BIN)/hpmoon -lOpenCL -lnvidia-ml $(OMP)

# ************ Cleaning ***************

.PHONY: clean eraseAll
clean:
