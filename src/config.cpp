...
Config::Config(const int argc, const char **argv) {
	...
	CmdParser parser("DESCRIPTION: Hpmoon is a parallel and distributed multi-objective genetic algorithm to EEG classification", "mpirun [MPI OPTIONS] ./bin/hpmoon [ARGS]", "Hpmoon (c) 2015 University of Granada");
