...
Hpmoon is fully documented in its [Github Pages](https://efficomp.github.io/Mjolnir/). In addition, the `Makefile` file contains a rule to generate [Doxygen](https://www.doxygen.nl/index.html) documentation in the `docs/html` folder.
